...
import { getSocialNotifyConfig, saveSocialNotifyConfig, SocialNotifyConfig, getWhatsAppShareUrl, formatWhatsAppPhone } from "../lib/socialNotifyHelper";
...
export default function Settings({ 
  ...
  const handleSaveSocialConfig = (updated: Partial<SocialNotifyConfig>) => {
    ...
    triggerToast(
      isLao ? "ບັນທຶກການຕັ້ງຄ່າ WhatsApp ສຳເລັດ!" : "WhatsApp settings saved!"
    );
  };
    ...
    <div id="settings-view" className="space-y-8 font-sans pb-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-7 space-y-8">
          ...
          {/* Admin WhatsApp Social Notification Integration Card (Only visible to Admin) */}
            ...
            <div id="admin-social-notify-card" className="bg-gradient-to-br from-emerald-950 via-slate-900 to-green-950 p-6 rounded-3xl border-2 border-emerald-500/40 shadow-xl text-white space-y-4 relative overflow-hidden">
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <h4 className="font-black text-sm text-white flex items-center gap-2">
                      <span>{isLao ? "ລະບົບເຊື່ອມຕໍ່ແຈ້ງເຕືອນ WhatsApp ແອດມິນ" : "WhatsApp Admin Notifications"}</span>
                    </h4>
                    <p className="text-[10px] text-emerald-200 font-medium">
                      {isLao ? "ສົ່ງຂໍ້ຄວາມແຈ້ງເຕືອນການຈອງຫ້ອງປະຊຸມໃໝ່ເຂົ້າແອັບ WhatsApp ແອດມິນໂດຍກົງ" : "Instant booking alert dispatch to Admin WhatsApp app"}
                    </p>
                  </div>
                </div>
              ...
              <div className="pt-2">
                ...
                >
                  ...
                  <span>{isLao ? "ທົດລອງສົ່ງແຈ້ງເຕືອນ WhatsApp ຫາແອດມິນ" : "Test Admin WhatsApp Alert"}</span>
                </button>
              </div>
            </div>
          )}
